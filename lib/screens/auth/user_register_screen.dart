        ...
        child: ListView(
          ...
          children: [
            ...
            _sectionLabel('Personal Information',
                Icons.person_rounded, AppTheme.primaryRed),
            ...
            // ── BLOOD INFO ────────────────────────────────
            _sectionLabel(
                'Medical Information', Icons.water_drop_rounded, AppTheme.primaryRed),
            const SizedBox(height: 12),
            ...
            Row(children: [
              _roleBtn('donor', Icons.volunteer_activism_rounded, 'Donor'),
              const SizedBox(width: 10),
              _roleBtn('patient', Icons.personal_injury_rounded, 'Patient'),
            ]),
            const SizedBox(height: 20),

            // ── ADDRESS ───────────────────────────────────
            _sectionLabel(
                'Address Details', Icons.location_on_rounded, AppTheme.green),
            const SizedBox(height: 12),
            _field(
            ...
            // ── PASSWORD ──────────────────────────────────
            _sectionLabel(
                'Set Password', Icons.lock_rounded, AppTheme.orange),
            const SizedBox(height: 12),
            TextFormField(
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          height: 48,
          decoration: BoxDecoration(
            color: active ? AppTheme.lightRed : Colors.white,
            border: Border.all(
                color: active ? AppTheme.primaryRed : AppTheme.gray200,
                width: 1.5),
            borderRadius: BorderRadius.circular(10),
          ),
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Icon(icon,
                color: active ? AppTheme.primaryRed : AppTheme.gray400,
                size: 18),
            ...
            Text(label,
                style: TextStyle(
                    fontSize: 13,
                    fontWeight: FontWeight.w600,
                    color: active ? AppTheme.primaryRed : AppTheme.gray600)),
          ]),
        ),
      ),
    );
